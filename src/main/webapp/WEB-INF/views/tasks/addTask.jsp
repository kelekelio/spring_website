...
<div class="form-group row">
  ...
  <select class="form-control" id="person.id" name="person.id">
    <option hidden>wybierz</option>
      ...
      <option id="name" value="${ppl.id}" temp="${items.person.id}" <c:if test="${ppl.id eq items.person.id}">selected</c:if> >${ppl.name} ${ppl.lastName}</option>
      </c:forEach>
  </select>
    </div>
</div>                     
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="form-group row">
                                    ...
                                    <div class="row">
                                    <div class="col-sm-2">
                                    <label class="radio-inline"><input type="radio" value="border-left-success" name="color">
                                    <i class="btn btn-success btn-circle btn-sm" ></i> poziom junior</label>
                                    </div>
                                    <div class="col-sm-2">
                                    <label class="radio-inline"><input type="radio" value="border-left-info" name="color">
                                    <i class="btn btn-info btn-circle btn-sm" ></i> poziom junior+</label>
                                    </div>
                                    <div class="col-sm-2">
                                    <label class="radio-inline"><input type="radio" value="border-left-secondary" name="color">
                                    <i class="btn btn-secondary btn-circle btn-sm" ></i> poziom mid</label>
                                    </div>
                                    <div class="col-sm-2">
                                    <label class="radio-inline"><input type="radio" value="border-left-primary" name="color">
                                    <i class="btn btn-primary btn-circle btn-sm" ></i> poziom mid+</label>
                                    </div>
                                    <div class="col-sm-2">
                                        <label class="radio-inline"><input type="radio" value="border-left-danger" name="color">
